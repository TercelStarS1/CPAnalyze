...
(function () {
    ...
    E = {
        ...
        colors: "#7cb5ec,#90ed7d,#f7a35c,#8085e9,#f15c80,#e4d354,#8085e8,#8d4653,#91e8e1".split(","),
    ...
    ba.scatter = w(S, {
        lineWidth: 0,
        tooltip: {   //formatDate
            headerFormat: ' <span style="color:{series.color}">●</span> <span style="font-size: 12px;"> ' + '{point.x}' + '</span><br/>',//'<span style="color:{series.color}">●</span> <span style="font-size: 10px;"> {series.name}</span><br/>',

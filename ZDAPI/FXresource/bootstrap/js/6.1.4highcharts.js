    ...
    var K = function() {
        ...
        a.Fx.prototype = {
            ...
            step: function(m) {
                ...
                u = t.duration,
                f = t.curAnim;
                x.attr && !x.element ? m = !1 : m || h >= u + this.startTime ? (this.now = this.end, this.pos = 1, this.update(), e = f[this.prop] = !0, a.objectEach(f,
                function(a) { ! 0 !== a && (e = !1)
            ...
            initPath: function(m, h, e) {
                ...
                function x(a, d) {
                    for (; a.length < l;) {
                        a[0] = d[l - a.length];
                        var c = a.slice(0, r); [].splice.apply(a, [0, 0].concat(c));
                        v && (c = a.slice(a.length - r), [].splice.apply(a, [a.length, 0].concat(c)), b--)
                    }
                    a[0] = "M"
                }
                function p(a, b) {
                    for (var c = (l - a.length) / r; 0 < c && c--;) d = a.slice().splice(a.length / q - r, r * q),
                    d[0] = b[l - r - c * r],
                    k && (d[r - 6] = d[r - 2], d[r - 5] = d[r - 1]),
                    [].splice.apply(a, [a.length / q, 0].concat(d)),
                    v && c--
                }
                h = h || "";
                var u, f = m.startX,
        ...
        a.merge = function() {
            ...
            x = function(e, m) {
                "object" !== typeof e && (e = {});
                a.objectEach(m,
                function(f, c) { ! a.isObject(f, !0) || a.isClass(f) || a.isDOMElement(f) ? e[c] = m[c] : e[c] = x(e[c] || {},
                    f)
                });
                return e
        ...
        a.attr = function(m, h, e) {
            var t;
            a.isString(h) ? a.defined(e) ? m.setAttribute(h, e) : m && m.getAttribute && ((t = m.getAttribute(h)) || "class" !== h || (t = m.getAttribute(h + "Name"))) : a.defined(h) && a.isObject(h) && a.objectEach(h,
            function(a, e) {
                m.setAttribute(e, a)
            });
            return t
        ...
        a.normalizeTickInterval = function(m, h, e, t, x) {
            ...
            e = a.pick(e, 1);
            p = m / e;
            h || (h = x ? [1, 1.2, 1.5, 2, 2.5, 3, 4, 5, 6, 8, 10] : [1, 2, 2.5, 5, 10], !1 === t && (1 === e ? h = a.grep(h,
            function(a) {
                return 0 === a % 1
            }) : .1 >= e && (h = [1 / e])));
        ...
        a.numberFormat = function(m, h, e, t) {
            ...
            u,
            f,
            c = m.toString().split("e"); - 1 === h ? h = Math.min(p, 20) : a.isNumber(h) ? h && c[1] && 0 > c[1] && (u = h + +c[1], 0 <= u ? (c[0] = ( + c[0]).toExponential(u).split("e")[0], h = u) : (c[0] = c[0].split(".")[0] || 0, m = 20 > h ? (c[0] * Math.pow(10, c[1])).toFixed(h) : 0, c[1] = 0)) : h = 2;
        ...
        a.getStyle = function(m, h, e) {
            ...
            if (m = F.getComputedStyle(m, void 0)) m = m.getPropertyValue(h),
            a.pick(e, "opacity" !== h) && (m = a.pInt(m));
            return m
        };
        ...
        a.fireEvent = function(m, h, e, t) {
            var x, p, u, f, c;
            e = e || {};
            E.createEvent && (m.dispatchEvent || m.fireEvent) ? (x = E.createEvent("Events"), x.initEvent(h, !0, !0), a.extend(x, e), m.dispatchEvent ? m.dispatchEvent(x) : m.fireEvent(h, x)) : a.each(["protoEvents", "hcEvents"],
            function(k) {
        ...
        a.Color.prototype = {
            ...
            init: function(e) {
                var h, x, p, u;
                if ((this.input = e = this.names[e && e.toLowerCase ? e.toLowerCase() : ""] || e) && e.stops) this.stops = F(e.stops,
                function(f) {
                    return new a.Color(f[1])
                });
                else if (e && e.charAt && "#" === e.charAt() && (h = e.length, e = parseInt(e.substr(1), 16), 7 === h ? x = [(e & 16711680) >> 16, (e & 65280) >> 8, e & 255, 1] : 4 === h && (x = [(e & 3840) >> 4 | (e & 3840) >> 8, (e & 240) >> 4 | e & 240, (e & 15) << 4 | e & 15, 1])), !x) for (p = this.parsers.length; p--&&!x;) u = this.parsers[p],
                (h = u.regex.exec(e)) && (x = u.parse(h));
                this.rgba = x || []
            },
            get: function(a) {
                var e = this.input,
                h = this.rgba,
                p;
                this.stops ? (p = m(e), p.stops = [].concat(p.stops), C(this.stops,
                function(e, f) {
            ...
            brighten: function(a) {
                ...
                else if (E(a) && 0 !== a) for (e = 0; 3 > e; e++) x[e] += h(255 * a),
                0 > x[e] && (x[e] = 0),
                255 < x[e] && (x[e] = 255);
                return this
            },
        ...
        l(C.prototype, {
            ...
            complexColor: function(z, g, b) {
                ...
                function() {
                    ...
                    function(a) {
                        w.push(a)
                    }), w = w.join(","), f[w] ? q = f[w].attr("id") : (l.id = q = a.uniqueKey(), f[w] = J = y.createElement(c).attr(l).add(y.defs), J.radAttr = n, J.stops = [], r(A,
                    function(z) {
            ...
            applyTextOutline: function(z) {
                ...
                if ((c = z[0]) && "none" !== c && a.svg) {
                    ...
                    for (n = z.length; n--;) b = z[n],
                    "highcharts-text-outline" === b.getAttribute("class") && d(z, g.removeChild(b));
                    l = g.firstChild;
                    r(z,
                    function(a, z) {
            ...
            attr: function(a, g, b, y) {
                ...
                c, l = this,
                n, f;
                "string" === typeof a && void 0 !== g && (z = a, a = {},
                a[z] = g);
                "string" === typeof a ? l = (this[a + "Getter"] || this._defaultGetter).call(this, a, d) : (M(a,
                function(z, g) {
                    n = !1;
                    y || Q(this, g);
                    this.symbolName && /^(x|y|width|height|r|start|end|innerR|anchorX|anchorY)$/.test(g) && (c || (this.symbolAttr(a), c = !0), n = !0); ! this.rotation || "x" !== g && "y" !== g || (this.doTransform = !0);
            ...
            updateShadows: function(a, g, b) {
                ...
                y = z.length; y--;) b.call(z[y], "height" === a ? Math.max(g - (z[y].cutHeight || 0), 0) : "d" === a ? this.d: g, a, z[y])
            },
            ...
            symbolAttr: function(a) {
                var z = this;
                r("x y r start end width height innerR anchorX anchorY".split(" "),
                function(g) {
                    z[g] = G(a[g], z[g])
                });
                z.attr({
            ...
            css: function(a) {
                ...
                M(a,
                function(a, z) { - 1 === q(z, J) && (c += z.replace(/([A-Z])/g, n) + ":" + a + ";")
            ...
            on: function(a, g) {
                ...
                b.onclick = function(a) { ( - 1 === O.navigator.userAgent.indexOf("Android") || 1100 < Date.now() - (z.touchEventFired || 0)) && g.call(b, a)
                }) : b["on" + a] = g;
                return this
            },
            ...
            updateTransform: function() {
                ...
                d ? a.push("rotate(90) scale(-1,1)") : c && a.push("rotate(" + c + " " + G(this.rotationOriginX, n.getAttribute("x"), 0) + " " + G(this.rotationOriginY, n.getAttribute("y") || 0) + ")"); (u(b) || u(y)) && a.push("scale(" + G(b, 1) + " " + G(y, 1) + ")");
            ...
            getBBox: function(a, g) {
                ...
                if (!z) {
                    if (d.namespaceURI === this.SVG_NS || b.forExport) {
                        try { (A = this.fakeTS &&
                            function(a) {
                                r(d.querySelectorAll(".highcharts-text-outline"),
                                function(z) {
                                    z.style.display = a
                                })
                            }) && A("none"),
            ...
            destroy: function() {
                ...
                Q(a);
                c && y && (r(y.querySelectorAll("[clip-path],[CLIP-PATH]"),
                function(a) {
            ...
            shadow: function(a, g, b) {
                ...
                if (!a) this.destroyShadows();
                    ...
                    b && (h(d, "height", Math.max(h(d, "height") - l, 0)), d.cutHeight = l),
                    g ? g.element.appendChild(d) : c.parentNode && c.parentNode.insertBefore(d, c),
                    z.push(d);
                    this.shadows = z
                }
                return this
            ...
            zIndexSetter: function(a, b) {
                ...
                this[b] = a;
                if (c) { (a = this.zIndex) && z && (z.handleZ = !0);
                    b = d.childNodes;
                    for (J = b.length - 1; 0 <= J && !n; J--) if (z = b[J], c = z.getAttribute("data-z-index"), f = !u(c), z !== l) if (0 > a && f && !y && !J) d.insertBefore(l, b[J]),
                    n = !0;
                    else if (g(c) <= a || f && (!u(a) || 0 <= a)) d.insertBefore(l, b[J + 1] || null),
                    n = !0;
        ...
        l(E.prototype, {
            ...
            truncate: function(a, g, b, y, d, c, l) {
                ...
                w = function(c, n) {
                    ...
                    } catch(X) {} else r(l(b || y, c)),
                    q[n] = d + z.getSpanWidth(a, g);
                    return q[n]
                },
                D,
                N;
                ...
                if (N = d + D > c) {
                    for (; J <= A;) v = Math.ceil((J + A) / 2),
                    y && (f = l(y, v)),
                    D = w(v, f && f.length - 1),
                    J === A ? J = A + 1 : D > c ? A = v - 1 : J = v;
            ...
            buildText: function(a) {
                ...
                if (u !== a.textCache) {
                    ...
                    n || e || B || w || -1 !== l.indexOf(" ") ? (v && v.appendChild(y), l = n ? l.replace(/<(b|strong)>/g, '\x3cspan style\x3d"font-weight:bold"\x3e').replace(/<(i|em)>/g, '\x3cspan style\x3d"font-style:italic"\x3e').replace(/<a/g, "\x3cspan").replace(/<\/(b|strong|i|em|a)>/g, "\x3c/span\x3e").split(/<br.*?>/g) : [l], l = b(l,
                    function(a) {
                        return "" !== a
                    }), r(l,
                    function(g, b) {
                        ...
                        function(g) {
                            if ("" !== g || 1 === l.length) {
                                ...
                                r,
                                D; (r = m(g, "class")) && h(q, "class", r);
                                if (r = m(g, "style")) r = r.replace(/(;| |^)color([ :])/, "$1fill$2"),
                                h(q, "style", r); (D = m(g, "href")) && !c && (h(q, "onclick", 'location.href\x3d"' + D + '"'), h(q, "class", "highcharts-anchor"), x(q, {
                                    cursor: "pointer"
                                }));
                                ...
                                if (" " !== g) {
                                    ...
                                    if (w) {
                                        ...
                                        D = 0;
                                        var u = H(q);
                                        if (B) f = d.truncate(a, q, g, void 0, 0, Math.max(0, w - parseInt(P || 12, 10)),
                                        function(a, g) {
                                            ...
                                            dy: u,
                                            x: A
                                        }), r && h(q, "style", r), q.appendChild(k.createTextNode(e.join(" ").replace(/- /g, "-"))), y.appendChild(q)),
                                        d.truncate(a, q, null, e, 0 === D ? z: 0, w,
                                        function(a, g) {
            ...
            button: function(a, g, b, y, d, c, n, f, J) {
                ...
                r = f.style;
                delete f.style;
                F(z.element, L ? "mouseover": "mouseenter",
                function() {
                    3 !== A && z.setState(1)
                });
                F(z.element, L ? "mouseout": "mouseleave",
                function() {
                    3 !== A && z.setState(A)
                });
            ...
            text: function(a, g, b, y) {
                ...
                y || (a.xSetter = function(a, g, b) {
                    ...
                    d.getAttribute(g) === c && d.setAttribute(g, a);
                    b.setAttribute(g, a)
                });
                return a
            },
            ...
            label: function(g, b, d, c, n, f, J, A, v) {
                ...
                R = function() {
                    ...
                    if (a !== w.x || g !== w.y) w.attr("x", a),
                    w.hasBoxWidthChanged && (N = w.getBBox(!0), L()),
                    void 0 !== g && w.attr("y", g);
                    w.x = a;
                    w.y = g
                };
            ...
            htmlUpdateTransform: function() {
                if (this.added) {
                    ...
                    if ("SPAN" === d.tagName) {
                        ...
                        A; (A = n !== this.oldTextWidth) && !(A = n > this.oldTextWidth) && ((A = this.textPxLength) || (F(d, {
                            width: "",
                            whiteSpace: u || "nowrap"
        ...
        a.Time.prototype = {
            ...
            update: function(a) {
                ...
                this.getTimezoneOffset = this.timezoneOffsetFunction(); (this.variableTimezone = !(e && !a.getTimezoneOffset && !a.timezone)) || this.timezoneOffset ? (this.get = function(a, c) {
                    var f = c.getTime(),
                ...
                this.set = function(a, c, k) {
                    ...
                    else f = u.getTimezoneOffset(c),
                    f = c.getTime() - f,
                    c.setTime(f),
                    c["setUTC" + a](k),
                    a = u.getTimezoneOffset(c),
                    f = c.getTime() + a,
                    c.setTime(f)
            ...
            getTimeTicks: function(a, p, u, f) {
                ...
                if (C(p)) {
                    ...
                    p = r.getTime();
                    for (r = 1; p < u;) k.push(p),
                    p = b === e.year ? c.makeTime(d + r * v, 0) : b === e.month ? c.makeTime(d, f + r * v) : !q || b !== e.day && b !== e.week ? q && b === e.hour && 1 < v ? c.makeTime(d, f, I, w + r * v) : p + b * v: c.makeTime(d, f, I + r * v * (b === e.day ? 1 : 7)),
                    r++;
                    k.push(p);
                    b <= e.hour && 1E4 > k.length && E(k,
                    function(a) {
    ...
    var V = function(a) {
        ...
        a.extend(G.prototype, {
            ...
            defaultLabelFormatter: function() {
                ...
                else if (k && 1E3 <= g) for (; k--&&void 0 === A;) d = Math.pow(l, k + 1),
                g >= d && 0 === 10 * b % d && null !== f[k] && 0 !== b && (A = a.numberFormat(b / d, -1) + f[k]);
                ...
                function() {
                    ...
                    function(g) {
                        if (g.visible || !b.options.chart.ignoreHiddenSeries) {
                            ...
                            if (a.isXAxis) y = g.xData,
                            y.length && (g = m(y), n = F(y), q(g) || g instanceof Date || (y = d(y, q), g = m(y), n = F(y)), y.length && (a.dataMin = Math.min(H(a.dataMin, y[0], g), g), a.dataMax = Math.max(H(a.dataMax, y[0], n), n)));
            ...
            getMinorTickPositions: function() {
                ...
                l = a.max + l,
                A = l - k;
                if (A && A / c < a.len / 3) if (a.isLog) f(this.paddedTicks,
                function(g, b, d) {
                ...
                else for (b = k + (d[0] - k) % c; b <= l && b !== n[0]; b += c) n.push(b);
            ...
            adjustForMinRange: function() {
                ...
                d = this.max,
                c, n, l, k, A, q, v, e;
                this.isXAxis && void 0 === this.minRange && !this.isLog && (x(a.min) || x(a.max) ? this.minRange = null: (f(this.series,
                function(a) {
                    q = a.xData;
            ...
            getClosest: function() {
                ...
                function(g) {
                    ...
                    d = g.visible || !g.chart.options.chart.ignoreHiddenSeries; ! g.noSharedTooltip && x(b) && d && (a = x(a) ? Math.min(a, b) : b)
                });
                return a
            },
            nameToX: function(a) {
            ...
            updateNames: function() {
                var g = this,
                b = this.names;
                0 < b.length && (f(a.keys(b.keys),
                function(a) {
                    delete b.keys[a]
                }), b.length = 0, this.minRange = this.userMinRange, f(this.series || [],
                function(a) {
                    a.xIncrement = null;
            ...
            setAxisTranslation: function(a) {
                ...
                v = b.transA,
                e = b.isXAxis;
                if (e || q || d) c = b.getClosest(),
                A ? (n = A.minPointOffset, l = A.pointRangePadding) : f(b.series,
                function(a) {
                ...
                A = b.ordinalSlope && c ? b.ordinalSlope / c: 1,
                b.minPointOffset = n *= A,
                b.pointRangePadding = l *= A,
                b.pointRange = Math.min(d, g),
                e && (b.closestPointRange = c);
                a && (b.oldTransA = v);
            ...
            setTickInterval: function(b) {
                ...
                g.adjustForMinRange(); ! (G || g.axisPointRange || g.usePercentage || w) && x(g.min) && x(g.max) && (d = g.max - g.min) && (!x(p) && D && (g.min -= d * D), !x(t) && r && (g.max += d * r));
                ...
                b = H(c.minTickInterval, g.isDatetimeAxis && g.closestPointRange); ! h && g.tickInterval < b && (g.tickInterval = b);
            ...
            trimTicks: function(a, b, d) {
                ...
                if (!this.isLinked) {
                    ...
                    else for (; this.min - n > a[0];) a.shift();
                    if (d) this.max = c;
                    else for (; this.max + n < a[a.length - 1];) a.pop();
                    0 === a.length && x(g) && !this.options.tickPositions && a.push((c + g) / 2)
                }
            },
            alignToOthers: function() {
                var a = {},
                b, d = this.options; ! 1 === this.chart.options.chart.alignTicks || !1 === d.alignTicks || !1 === d.startOnTick || !1 === d.endOnTick || this.isLog || f(this.chart[this.coll],
                function(g) {
                    var d = g.options,
            ...
            getTickAmount: function() {
                var a = this.options,
                b = a.tickAmount,
                d = a.tickPixelInterval; ! x(a.tickInterval) && this.len < d && !this.isRadial && !this.isLog && a.startOnTick && a.endOnTick && (b = 2); ! b && this.alignToOthers() && (b = Math.ceil(this.len / d) + 1);
            ...
            zoom: function(a, b) {
                ...
                if (a !== this.min || b !== this.max) this.allowZoomOutside || (x(g) && (a < n && (a = n), a > c && (a = c)), x(d) && (b < n && (b = n), b > c && (b = c))),
            ...
            unsquish: function() {
                ...
                b ? (w = !a.staggerLines && !a.step && (x(k) ? [k] : n < H(a.autoRotationLimit, 80) && a.autoRotation)) && f(w,
                function(a) {
                    var b;
                    if (a === k || a && -90 <= a && 90 >= a) q = r(Math.abs(A.h / Math.sin(p * a))),
                    b = q + Math.abs(a / 360),
                    b < v && (v = b, l = a, c = q)
                }) : a.step || (c = r(A.h));
                this.autoRotation = w;
            ...
            renderUnsquish: function() {
                ...
                f(d,
                function(a) { (a = c[a]) && a.label && a.label.textPxLength > h && (h = a.label.textPxLength)
                });
                this.maxLabelLength = h;
                if (this.autoRotation) h > q && h > e.h ? v.rotation = this.labelRotation: this.labelRotation = 0;
                else if (A && (r = q, !w)) for (D = "clip", q = d.length; ! k && q--;) if (B = d[q], B = c[B].label) B.styles && "ellipsis" === B.styles.textOverflow ? B.css({
                    textOverflow: "clip"
            ...
            getOffset: function() {
                ...
                function(b, d) {
                    ...
                    1 : "left",
                    3 : "right"
                } [q] === a.labelAlign, H(I.reserveSpace, "center" === a.labelAlign ? !0 : null, a.reserveSpaceDefault) && f(n,
                function(a) {
                    u = Math.max(l[a].getLabelSize(), u)
                }), a.staggerLines && (u *= a.staggerLines), a.labelOffset = u * (a.opposite ? -1 : 1)) : B(l,
                function(a, b) {
                    a.destroy();
                    delete l[b]
                });
            ...
            render: function() {
                ...
                if (b.hasData() || l) b.minorTickInterval && !b.categories && f(b.getMinorTickPositions(),
                function(a) {
                    b.renderMinorTick(a)
                }),
                v.length && (f(v,
                function(a, d) {
                    b.renderTick(a, d)
                }), I && (0 === b.min || b.single) && (w[ - 1] || (w[ - 1] = new M(b, -1, null, !0)), w[ - 1].render( - 1))),
                G && f(v,
                function(c, g) {
                ...
                b._addedPlotLB || (f((c.plotLines || []).concat(c.plotBands || []),
                function(a) {
            ...
            destroy: function(a) {
                ...
                f([d.ticks, d.minorTicks, d.alternateBands],
                function(a) {
                    u(a)
                });
                if (g) for (a = g.length; a--;) g[a].destroy();
                f("stackTotalGroup axisLine axisTitle axisGroup gridGroup labelGroup cross scrollbar".split(" "),
                function(a) {
                    d[a] && (d[a] = d[a].destroy())
                });
        ...
        C.prototype.getLogTickPositions = function(a, t, x, p) {
            ...
            c = this.getLinearTickPositions(a, t, x);
            else if (.08 <= a) for (var f = Math.floor(t), k, r, l, d, b, e = .3 < a ? [1, 2, 4] : .15 < a ? [1, 2, 4, 6, 8] : [1, 2, 3, 4, 5, 6, 7, 8, 9]; f < x + 1 && !b; f++) for (r = e.length, k = 0; k < r && !b; k++) l = this.log2lin(this.lin2log(f) * e[k]),
            l > t && (!p || d <= x) && void 0 !== d && c.push(d),
            d > x && (b = !0),
            d = l;
            else t = this.lin2log(t),
            x = this.lin2log(x),
            a = p ? this.getMinorTickInterval() : e.tickInterval,
            a = h("auto" === a ? null: a, this._minorAutoInterval, e.tickPixelInterval / (p ? 5 : 1) * (x - t) / ((p ? f / this.tickPositions.length: f) || 1)),
            a = m(a, null, E(a)),
            c = F(this.getLinearTickPositions(a, t, x), this.log2lin),
            p || (this._minorAutoInterval = a / 5);
        ...
        a.PlotLineOrBand.prototype = {
            render: function() {
                ...
                A.zIndex = n;
                G += "-" + n; (H = f.plotLinesAndBandsGroups[G]) || (f.plotLinesAndBandsGroups[G] = H = M.g("plot-" + G).attr(A).add());
        ...
        a.extend(C.prototype, {
            getPlotBandPath: function(a, f) {
                ...
                if (k && c) for (a && (b = k.toString() === c.toString(), d = 0), a = 0; a < k.length; a += 6) l && c[a + 1] === k[a + 1] ? (c[a + 1] += d, c[a + 4] += d) : l || c[a + 2] !== k[a + 2] || (c[a + 2] += d, c[a + 5] += d),
                e.push("M", k[a + 1], k[a + 2], "L", k[a + 4], k[a + 5], c[a + 4], c[a + 5], c[a + 1], c[a + 2], "z"),
                e.isFlat = b;
                return e
            },
            ...
            removePlotBandOrLine: function(a) {
                ...
                c = this.options,
                k = this.userOptions,
                h = f.length; h--;) f[h].id === a && f[h].destroy();
                e([c.plotLines || [], k.plotLines || [], c.plotBands || [], k.plotBands || []],
                function(c) {
        ...
        a.Tooltip.prototype = {
            ...
            getAnchor: function(a, f) {
                ...
                w, m;
                a = p(a);
                this.followPointer && f ? (void 0 === f.chartX && (f = l.normalize(f)), a = [f.chartX - c.plotLeft, f.chartY - b]) : a[0].tooltipPos ? a = a[0].tooltipPos: (E(a,
                function(a) {
                    w = a.series.yAxis;
                    m = a.series.xAxis;
            ...
            getPosition: function(a, f, e) {
                ...
                g = function() { ! 1 !== A.apply(0, H) ? !1 !== M.apply(0, n) || q || (G(!0), g()) : q ? b.x = b.y = 0 : (G(!0), g())
            ...
            refresh: function(c, f) {
                ...
                var q = this.shared,
                w;
                l.enabled && (a.clearTimeout(this.hideTimer), this.followPointer = p(b)[0].series.tooltipOptions.followPointer, e = this.getAnchor(b, f), f = e[0], d = e[1], !q || b.series && b.series.noSharedTooltip ? q = b.getLabelConfig() : (E(b,
                function(a) {
                    a.setState("hover");
            ...
            tooltipFooterHeaderFormatter: function(a, f) {
                ...
                e && d && E(a.point && a.point.tooltipDateKeys || ["key"],
                function(a) {
        ...
        a.Pointer.prototype = {
            ...
            getHoverData: function(b, d, f, l, e, k, h) {
                ...
                v = h && h.isBoosting;
                l = !(!l || !b);
                h = d && !d.stickyTracking ? [d] : a.grep(f,
                function(a) {
                ...
                q && (e && !d.noSharedTooltip ? (h = a.grep(f,
                function(a) {
            ...
            runPointActions: function(b, d) {
                ...
                if (e && (e !== c.hoverPoint || f && f.isHidden)) {
                    t(c.hoverPoints || [],
                    function(b) { - 1 === a.inArray(b, h) && b.setState()
                    });
                    t(h || [],
                    function(a) {
                        a.setState("hover")
            ...
            reset: function(a, d) {
                ...
                if (a) k && h && (k.refresh(h), k.shared && e ? t(e,
                function(a) {
                ...
                }) : f && (f.setState(f.state, !0), t(b.axes,
                function(a) {
        ...
        F(a.Pointer.prototype, {
            ...
            pinchTranslateDirection: function(a, e, h, m, f, c, k, r) {
                ...
                g = !D && h[1][v],
                y;
                h = function() { ! D && 20 < Math.abs(A - G) && (B = r || Math.abs(M - g) / Math.abs(A - G));
                    t = (p - M) / B + A;
            ...
            pinch: function(a) {
                ...
                "touchstart" === a.type ? (E(f,
                function(a, b) {
                    u[b] = {
                        chartX: a.chartX,
                        chartY: a.chartY
                    }
                }), k.x = [u[0].chartX, u[1] && u[1].chartX], k.y = [u[0].chartY, u[1] && u[1].chartY], E(p.axes,
                function(a) {
                    if (a.zoomEnabled) {
        ...
        if (!a.hasTouch && (p.PointerEvent || p.MSPointerEvent)) {
            ...
            h(t.prototype, {
                onContainerPointerDown: function(a) {
                    r(a, "onContainerTouchStart", "touchstart",
                    function(a) {
                        f[a.pointerId] = {
                            pageX: a.pageX,
                            pageY: a.pageY,
                ...
                onContainerPointerMove: function(a) {
                    r(a, "onContainerTouchMove", "touchmove",
                    function(a) {
                        f[a.pointerId] = {
                            pageX: a.pageX,
                            pageY: a.pageY
                ...
                onDocumentPointerUp: function(a) {
                    r(a, "onDocumentTouchEnd", "touchend",
                    function(a) {
        ...
        a.Legend.prototype = {
            ...
            adjustMargins: function(a, c) {
                ...
                d = this.options,
                f = this.getAlignment();
                f && h([/(lth|ct|rth)/, /(rtv|rm|rbv)/, /(rbh|cb|lbh)/, /(lbv|lm|ltv)/],
                function(e, k) {
            ...
            proximatePositions: function() {
                ...
                function(f) {
                    var e, k;
                    e = b;
                    f.xAxis && f.points && (f.xAxis.options.reversed && (e = !e), e = a.find(e ? f.points: f.points.slice(0).reverse(),
                    function(b) {
            ...
            handleOverflow: function(a) {
                ...
                k && (b = Math.min(b, k));
                t.length = 0;
                a > b && !1 !== p.enabled ? (this.clipHeight = r = Math.max(b - 20 - this.titleHeight - l, 0), this.currentPage = u(this.currentPage, 1), this.fullHeight = a, h(g,
                function(a, b) {
                    var c = a._legendItemPos[1],
                    d = Math.round(a.legendItem.getBBox().height),
                    f = t.length;
                    if (!f || c - t[f - 1] > r && (G || c) !== t[f - 1]) t.push(G || c),
                    f++;
                    a.pageIx = f - 1;
                    G && (g[b - 1].pageIx = f - 1);
                    ...
                    zIndex: 1
                }).add(this.group), this.up = f.symbol("triangle", 0, 0, D, D).on("click",
                function() {
                    c.scroll( - 1, n)
                }).add(A), this.pager = f.text("", 15, 10).addClass("highcharts-legend-navigation").css(p.style).add(A), this.down = f.symbol("triangle-down", 0, 0, D, D).on("click",
                function() {
                    c.scroll(1, n)
        ...
        }; (/Trident\/7\.0/.test(k.navigator.userAgent) || t) && r(a.Legend.prototype, "positionItem",
        function(a, c) {
            var b = this,
            d = function() {
        ...
        r(N.prototype, {
            ...
            initSeries: function(b) {
                var c = this.options.chart; (c = G[b.type || c.type || c.defaultSeriesType]) || a.error(17, !0);
                c = new c;
                c.init(this, b);
                return c
            },
            ...
            redraw: function(b) {
                ...
                if (A) for (b = g.length; b--;) q = g[b],
                q.options.stacking && (q.isDirty = !0);
                k(g,
                function(a) {
                ...
                d(this, "predraw");
                k(g,
                function(a) { (y || a.isDirty) && a.visible && a.redraw();
                    a.isDirtyData = !1
                });
                f && f.reset(!0);
                w.draw();
            ...
            layOutTitles: function(a) {
                ...
                this.titleOffset = b; ! this.isDirtyBox && c && (this.isDirtyBox = this.isDirtyLegend = c, this.hasRendered && D(a, !0) && this.isDirtyBox && this.redraw())
            },
            ...
            setReflow: function(a) {
                var b = this; ! 1 === a || this.unbindReflow ? !1 === a && this.unbindReflow && (this.unbindReflow = this.unbindReflow()) : (this.unbindReflow = C(Q, "resize",
                function(a) {
                    b.reflow(a)
            ...
            setSize: function(b, c, g) {
                ...
                n.getChartSize();
                b = e.globalAnimation; (b ? E: f)(n.container, {
            ...
            render: function() {
                ...
                if (g || f) k(a,
                function(a) { (a.horiz && g || !a.horiz && f) && a.setTickInterval(!0)
                }),
                this.getMargins();
                this.drawChartBox();
        ...
        E = a.Chart,
        F = a.each;
        C(E, "afterSetChartSize",
        function(m) {
            var h = this.options.chart.scrollablePlotArea; (h = h && h.minWidth) && !this.renderer.forExport && (this.scrollablePixels = h = Math.max(0, h - this.chartWidth)) && (this.plotWidth += h, this.clipBox.width += h, m.skipAxes || F(this.axes,
            function(e) {
        ...
        a.Point.prototype = {
            ...
            optionsToObject: function(f) {
                ...
                else if (t(f)) for (!h && f.length > d && (e = typeof f[0], "string" === e ? c.name = f[0] : "number" === e && (c.x = f[0]), b++); m < d;) h && void 0 === f[b] || (0 < l[m].indexOf(".") ? a.Point.prototype.setNestedProperty(c, f[b], l[m]) : c[l[m]] = f[b]),
                b++,
                m++;
            ...
            firePointEvent: function(a, c, e) {
                var f = this,
                k = this.series.options; (k.point.events[a] || f.options && f.options.events && f.options.events[a]) && this.importEvents();
        ...
        },
        {
            ...
            bindAxes: function() {
                ...
                function(n) {
                    ...
                    function(a) {
                        f = a.options;
                        if (c[n] === f.index || void 0 !== c[n] && c[n] === f.id || void 0 === c[n] && 0 === f.index) b.insert(a.series),
                        b[n] = a,
                        a.isDirty = !0
                    });
            ...
            updateData: function(b) {
                ...
                this);
                if (n) for (b = d.length; b--;) g = d[b],
                g.touched || g.remove(!1),
                g.touched = !1;
                else if (b.length === d.length) p(b,
                function(a, b) {
            ...
            setData: function(b, c, f, e) {
                ...
                b = b || [];
                h = b.length;
                c = q(c, !0); ! 1 !== e && h && k && !n.cropped && !n.hasGroupedData && n.visible && !n.isSeriesBoosting && (H = this.updateData(b));
                if (!H) {
                    n.xIncrement = null;
                    n.colorCounter = 0;
                    ...
                    if (B && h > B) {
                        for (f = 0; null === m && f < h;) m = b[f],
                        f++;
                        if (l(m)) for (f = 0; f < h; f++) v[f] = this.autoIncrement(),
                        t[f] = b[f];
                        else if (r(m)) if (u) for (f = 0; f < h; f++) m = b[f],
                        v[f] = m[0],
                        t[f] = m.slice(1, u + 1);
                        else for (f = 0; f < h; f++) m = b[f],
                        v[f] = m[0],
                        t[f] = m[1];
                        else a.error(12)
                    } else for (f = 0; f < h; f++) void 0 !== b[f] && (m = {
                        series: n
                    },
            ...
            processData: function(b) {
                ...
                for (h = c.length || 1; --h;) f = q ? l(c[h]) - l(c[h - 1]) : c[h] - c[h - 1],
                0 < f && (void 0 === e || f < e) ? e = f: 0 > f && w && (a.error(15), w = !1);
                this.cropped = g;
                this.cropStart = n;
            ...
            generatePoints: function() {
                ...
                for (p = 0; p < h; p++) r = l + p,
                m ? (q = (new k).init(this, [e[p]].concat(w(g[p]))), q.dataGroup = this.groupMap[p], q.dataGroup.options && (q.options = q.dataGroup.options, f(q, q.dataGroup.options))) : (q = c[r]) || void 0 === b[r] || (c[r] = q = (new k).init(this, b[r], e[p])),
                q && (q.index = r, B[p] = q);
                this.options.keys = a;
                if (c && (h !== (d = c.length) || m)) for (p = 0; p < d; p++) p !== l || m || (p += h),
            ...
            getExtremes: function(a) {
                ...
                d = a.length;
                for (B = 0; B < d; B++) if (h = c[B], w = a[B], k = (l(w, !0) || r(w)) && (!b.positiveValuesOnly || w.length || 0 < w), h = this.getExtremesFromAll || this.options.getExtremesFromAll || this.cropped || (c[B + q] || h) >= n && (c[B - q] || h) <= e, k && h) if (k = w.length) for (; k--;)"number" === typeof w[k] && (f[g++] = w[k]);
                else f[g++] = w;
                this.dataMin = m(f);
                this.dataMax = F(f)
            },
            ...
            setClip: function(a) {
                ...
                a && !k.count[this.index] && (k.count[this.index] = !0, k.count.length += 1); ! 1 !== c.clip && (this.group.clip(a || g ? k: b.clipRect), this.markerGroup.clip(h), this.sharedClipKey = n);
            ...
            drawPoints: function() {
                ...
                k = d.marker || {},
                h = !!d.marker,
                f = w && void 0 === k.enabled || k.enabled,
                l = d.isInside,
                f && !d.isNull ? (f = q(k.symbol, this.symbol), m = this.markerAttribs(d, d.selected && "select"), g ? g[l ? "show": "hide"](!0).animate(m) : l && (0 < m.width || d.hasImage) && (d.graphic = g = b.renderer.symbol(f, m.x, m.y, m.width, m.height, h ? k: e).add(r)), g && g.attr(this.pointAttribs(d, d.selected && "select")), g && g.addClass(d.getClassName(), !0)) : g && (d.graphic = g.destroy())
            },
            ...
            pointAttribs: function(a, b) {
                ...
                d = q(b.lineWidth, c.lineWidth, d + q(b.lineWidthPlus, c.lineWidthPlus, 0)), a = b.fillColor || c.fillColor || a, g = b.lineColor || c.lineColor || g);
                return {
                    stroke: g,
                    "stroke-width": d,
                    fill: a
            ...
            destroy: function() {
                ...
                I(b);
                p(b.axisTypes || [],
                function(a) { (l = b[a]) && l.series && (u(l.series, b), l.isDirty = l.forceRedraw = !0)
                });
            ...
            getGraphPath: function(a, b, c) {
                ...
                a = a || d.points; (e = a.reversed) && a.reverse(); (g = {
                    right: 1,
                    center: 2
                } [g] || g && 3) && e && (g = 4 - g); ! f.connectNulls || b || c || (a = this.getValidPoints(a));
                p(a,
                function(e, l) {
                    var m = e.plotX,
                    r = e.plotY,
                    q = a[l - 1]; (e.leftCliff || q && q.rightCliff) && !c && (h = !0);
            ...
            applyZones: function() {
                ...
                x,
                I = !1;
                d.length && (h || l) && r && void 0 !== r.min && (B = r.reversed, t = r.horiz, h && !this.showLine && h.hide(), l && l.hide(), w = r.getExtremes(), p(d,
                function(d, n) {
            ...
            render: function() {
                ...
                a.invertGroups(r); ! 1 === f.clip || a.sharedClipKey || h || d.clip(b.clipRect);
                e && a.animate();
            ...
            buildKDTree: function() {
                function a(c, d, f) {
                    var g, e;
                    if (e = c && c.length) return g = b.kdAxisArray[d % f],
                    c.sort(function(a, b) {
                        return a[g] - b[g]
                    }),
                    e = Math.floor(e / 2),
        ...
        a.StackItem.prototype = {
            ...
            setOffset: function(a, c) {
                ...
                f = m(h) && this.getStackBox(e, this, a, h, c, d, f); (c = this.label) && f && (c.align(this.alignOptions, null, f), f = c.alignAttr, c[!1 === this.options.crop || e.isInsidePlot(f.x, f.y) ? "show": "hide"](!0))
            },
        ...
        E.prototype.getStacks = function() {
            ...
            e(a.series,
            function(c) { ! c.options.stacking || !0 !== c.visible && !1 !== a.options.chart.ignoreHiddenSeries || (c.stackKey = c.type + p(c.options.stack, ""))
            })
        };
        ...
        C.prototype.cleanStacks = function() {
            var a;
            this.isXAxis || (this.oldStacks && (a = this.stacks = this.oldStacks), x(a,
            function(a) {
                x(a,
                function(a) {
        ...
        u.prototype.setStackedPoints = function() {
            if (this.options.stacking && (!0 === this.visible || !1 === this.chart.options.chart.ignoreHiddenSeries)) {
                ...
                A = (D = w && y < (b ? 0 : d)) ? t: q,
                B[A] || (B[A] = {}),
                B[A][g] || (H[A] && H[A][g] ? (B[A][g] = H[A][g], B[A][g].total = null) : B[A][g] = new a.StackItem(u, u.options.stackLabels, D, g, v)),
                A = B[A][g],
                null !== y ? (A.points[x] = A.points[this.index] = [p(A.cumulative, b)], m(A.cumulative) || (A.base = x), A.touched = u.stacksTouched, 0 < n.index && !1 === this.singleStacks && (A.points[x][0] = A.points[this.index + "," + g + ",0"][0])) : A.points[x] = A.points[this.index] = null,
                "percent" === l ? (D = D ? q: t, w && B[D] && B[D][g] ? (D = B[D][g], A.total = D.total = Math.max(D.total, A.total) + Math.abs(y) || 0) : A.total = F(A.total + (Math.abs(y) || 0))) : A.total = F(A.total + (y || 0)),
                A.cumulative = p(A.cumulative, b) + (y || 0),
                null !== y && (A.points[x].push(A.cumulative), e[G] = A.cumulative);
        ...
        u.prototype.modifyStacks = function() {
            ...
            function(b) {
                for (var c = m.length,
                f, e; c--;) if (f = m[c], l = a.getStackIndicator(l, f, a.index, b), e = (f = h[b] && h[b][f]) && f.points[l.key]) a[d + "Stacker"](e, f, c)
            })
        };
        ...
        u.prototype.getStackIndicator = function(a, c, e, h) { ! m(a) || a.x !== c || h && a.key !== h ? a = {
                x: c,
                index: 0,
                key: h
            }: a.index++;
        ...
        p(a.Chart.prototype, {
            ...
            update: function(a, h, k, m) {
                ...
                if (w) {
                    ...
                    if ("inverted" in w || "polar" in w || "type" in w) n.propFromSeries(),
                    g = !0;
                    "alignTicks" in w && (g = !0);
                    d(w,
                    function(a, b) { - 1 !== f("chart." + b, n.propsRequireUpdateSeries) && (r = !0); - 1 !== f(b, n.propsRequireDirtyBox) && (n.isDirtyBox = !0)
                    });
                ...
                function(b) {
                    var c;
                    a[b] && ("series" === b && (c = [], t(n[b],
                    function(a, b) {
                        a.options.isInternal || c.push(b)
                    })), t(L(a[b]),
                    function(a, d) { (d = e(a.id) && n.get(a.id) || n[b][c ? c[d] : d]) && d.coll === b && (d.update(a, !1), k && (d.touched = !0));
                        if (!d && k) if ("series" === b) n.addSeries(a, !1).touched = !0;
        ...
        p(v.prototype, {
            update: function(a, c, d, f) {
                ...
                l, m = n.chart,
                w = n.options;
                c = b(c, !0); ! 1 === f ? e() : h.firePointEvent("update", {
                    options: a
                },
                e)
            },
        ...
        p(q.prototype, {
            ...
            remove: function(a, c, d) {
                ...
                var e = this,
                h = e.chart; ! 1 !== d ? u(e, "remove", null, f) : f()
            },
            update: function(c, d) {
                var e = this,
                h = e.chart,
                ...
                z = 0 < H.length;
                t(H,
                function(a) { - 1 === f(a, x) && (z = !1)
                });
                if (z) c.data && this.setData(c.data, !1),
        ...
        },
        {
            ...
            getStackPoints: function(e) {
                ...
                if (this.options.stacking) {
                    for (q = 0; q < e.length; q++) e[q].leftNull = e[q].rightNull = null,
                    k[e[q].x] = e[q];
                    a.objectEach(c,
                    function(a, b) {
                    ...
                    function(a, e) {
                        var l = 0,
                        m, w;
                        if (k[a] && !k[a].isNull) h.push(k[a]),
                        E([ - 1, 1],
                        function(f) {
                            var h = 1 === f ? "rightNull": "leftNull",
                            n = 0,
                            l = c[p[e + f]];
                            if (l) for (q = r; 0 <= q && q < d;) m = l.points[q],
                            m || (q === r ? k[a][h] = !0 : b[q] && (w = c[a].points[q]) && (n -= w[1] - w[0])),
                            q += v;
            ...
            getGraphPath: function(a) {
                ...
                for (c = 0; c < a.length; c++) if (k = a[c].isNull, b = m(a[c].rectPlotX, a[c].plotX), w = m(a[c].yBottom, I), !k || p) p || L(c, c - 1, "left"),
                k && !t && p || (l.push(a[c]), r.push({
                    x: c,
                    plotX: b,
                    plotY: w
                })),
        ...
        },
        {
            ...
            getColumnMetrics: function() {
                ...
                d, b = {},
                m = 0; ! 1 === c.grouping ? m = 1 : F(a.chart.series,
                function(c) {
                    var f = c.options,
                    e = c.yAxis,
                    k;
        ...
        },
        {
            ...
            setVisible: function(a, c) {
                ...
                c = p(c, e);
                a !== d.visible && (d.visible = d.options.visible = a = void 0 === a ? !d.visible: a, b.options.data[t(d, b.data)] = d.options, m(["graphic", "dataLabel", "connector", "shadowGroup"],
                function(b) {
        ...
        a.distribute = function(c, b, f) {
            ...
            function(c) {
                ...
                function() {
                    k[e].pos = c.pos + d;
                    if (Math.abs(k[e].pos - k[e].target) > f) return m(k.slice(0, e + 1),
                    function(a) {
                        delete a.pos
                    }),
                    k.reducedLen = (k.reducedLen || b) - .1 * b,
                    k.reducedLen > .1 * b && a.distribute(k, b, f),
                    !0;
                    d += k[e].size;
                    e++
                })) return ! 0
        ...
        c.prototype.drawDataLabels = function() {
            ...
            D = b.plotGroup("dataLabelsGroup", "data-labels", A && !t ? "hidden": "visible", k.zIndex || 6),
            A && (D.attr({
                opacity: +t
            }), t || C(b, "afterAnimate",
            function() {
            ...
            function(d) {
                ...
                t = !l,
                v;
                p = d.dlOptions || d.options && d.options.dataLabels; (g = u(p && p.enabled, r.enabled) && !d.isNull) && (g = !0 === c(d, p || k));
        ...
        k.pie && (k.pie.prototype.drawDataLabels = function() {
            ...
            R,
            S = [0, 0, 0, 0];
            d.visible && (h.enabled || d._hasPointLabels) && (m(b,
            function(a) {
            ...
            function(b, c) {
                ...
                w = [],
                t;
                if (q) for (d.sortByAngle(b, c - .5), 0 < d.maxLabelDistance && (l = Math.max(0, G - C - d.maxLabelDistance), n = Math.min(G + C + d.maxLabelDistance, f.plotHeight), m(b,
                function(a) {
                ...
                }), l = n + t - l, a.distribute(w, l, l / 5)), R = 0; R < q; R++) e = b[R],
                K = e.labelPos,
                g = e.dataLabel,
                z = !1 === e.visible ? "hidden": "inherit",
                O = l = K[1],
                w && F(e.distributeBox) && (void 0 === e.distributeBox.pos ? z = "hidden": (N = e.distributeBox.size, O = e.top + e.distributeBox.pos)),
                delete e.positionIndex,
                P = h.justify ? x[0] + (c ? -1 : 1) * (C + e.labelDistance) : d.getX(O < e.top + 2 || O > e.bottom - 2 ? l: O, c, e),
                g._attr = {
                    visibility: z,
                    align: K[6]
                },
                ...
                K.x = P,
                K.y = O,
                u(h.crop, !0) && (y = g.getBBox().width, l = null, P - y < k && 1 === c ? (l = Math.round(y - P + k), S[3] = Math.max(l, S[3])) : P + y > p - k && 0 === c && (l = Math.round(P + y - p + k), S[1] = Math.max(l, S[1])), 0 > O - N / 2 ? S[0] = Math.max(Math.round( - O + N / 2), S[0]) : O + N / 2 > r && (S[2] = Math.max(Math.round(O + N / 2 - r), S[2])), g.sideOverflow = l)
            }), 0 === E(S) || this.verifyDataLabelOverflow(S)) && (this.placeDataLabels(), l && m(this.points,
            function(a) {
                var b;
                t = a.connector;
                if ((g = a.dataLabel) && g._pos && a.visible && 0 < a.labelDistance) {
                    z = g._attr.visibility;
                    if (b = !t) a.connector = t = f.renderer.path().addClass("highcharts-data-label-connector  highcharts-color-" + a.colorIndex + (a.className ? " " + a.className: "")).add(d.dataLabelsGroup),
                    t.attr({
                        "stroke-width": l,
        ...
        function() {
            ...
            E(this.yAxis || [],
            function(e) {
                e.options.stackLabels && !e.options.stackLabels.allowOverlap && F(e.stacks,
                function(e) {
                    F(e,
                    function(e) {
                        a.push(e.label)
            ...
            function(e) {
                ...
                x = e.dataLabelCollections || ["dataLabel"]; (h.enabled || e._hasPointLabels) && !h.allowOverlap && e.visible && E(x,
                function(h) {
                    E(e.points,
                    function(e) {
        ...
        C.prototype.hideOverlappingLabels = function(a) {
            ...
            for (p = 0; p < e; p++) if (m = a[p]) m.oldOpacity = m.opacity,
            m.newOpacity = 1,
            m.absoluteBox = u(m);
            a.sort(function(a, c) {
                return (c.labelrank || 0) - (a.labelrank || 0)
            });
            for (p = 0; p < e; p++) for (k = (u = a[p]) && u.absoluteBox, m = p + 1; m < e; ++m) if (c = (f = a[m]) && f.absoluteBox, k && c && u !== f && 0 !== u.newOpacity && 0 !== f.newOpacity && (c = r(k.x, k.y, k.width, k.height, c.x, c.y, c.width, c.height)))(u.labelrank < f.labelrank ? u: f).newOpacity = 0;
            E(a,
            function(a) {
                var c, b;
        ...
        I = a.TrackerMixin = {
            ...
            drawTrackerGraph: function() {
                ...
                g ? g.attr({
                    ...
                    zIndex: 2
                }).addClass(c ? "highcharts-tracker-area": "highcharts-tracker-line").add(a.group), t([a.tracker, a.markerGroup],
                function(a) {
        ...
        x(E.prototype, {
            showResetZoom: function() {
                ...
                p(this, "beforeShowResetZoom", null,
                function() {
            ...
            zoom: function(a) {
                ...
                function(a) {
                    b = a.zoom()
                }), d.initiated = !1) : t(a.xAxis.concat(a.yAxis),
                function(a) {
                    var c = a.axis;
        ...
        x(d.prototype, {
            ...
            setState: function(a, b) {
                ...
                if (! (a === this.state && !b || this.selected && "select" !== a || !1 === h.enabled || a && (g || m && !1 === q.enabled) || a && t.states && t.states[a] && !1 === t.states[a].enabled)) {
                    ...
                    this.graphic.animate(f.pointAttribs(this, a), l(u.options.chart.animation, h.animation)),
                    v && this.graphic.animate(v, l(u.options.chart.animation, q.animation, k.animation)),
                    r && r.hide();
                    else {
                        if (a && q) {
                            k = t.symbol || f.symbol;
        ...
        x(b.prototype, {
            ...
            onMouseOut: function() {
                ...
                b.hoverSeries = null;
                if (d) d.onMouseOut();
                this && a.events.mouseOut && p(this, "mouseOut"); ! c || this.stickyTracking || c.shared && !this.noSharedTooltip || c.hide();
                this.setState()
            },
            setState: function(a) {
                var b = this,
        ...
        C.prototype.currentOptions = function(e) {
            function p(e, c, k, r) {
                ...
                a.objectEach(e,
                function(a, b) {
                    if (!r && -1 < F(b, ["series", "xAxis", "yAxis"])) for (a = t(a), k[b] = [], f = 0; f < a.length; f++) c[b][f] && (k[b][f] = {},
                    p(a[f], c[b][f], k[b][f], r + 1));
                    else h(a) ? (k[b] = m(a) ? [] : {},
                    p(a, c[b] || {},
                    k[b], r + 1)) : k[b] = c[b] || null
                })
            }
            var u = {};
